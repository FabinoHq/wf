...
#define WFC_WINDOWSASM_HEADER
    ...
    const char WFASMFooter[] =
        ...
        "    ret         ; Return to caller\n"
        "\n"
        "; WFGetCursorPosition : Get cursor position "
        "(x in ax, y in bx, or cur in eax)\n"
        "WFGetCursorPosition:\n"
        "    push rcx        ; Push pointer\n"
        "    push rdx        ; Push back pointer\n"
        "    push r10        ; Push memory address\n"
        ...
        "    ret       ; Return to caller\n"
        "\n"
        "; WFSetCursorPosition : Set cursor position "
        "(x in ax, y in bx, or cur in eax)\n"
        "WFSetCursorPosition:\n"
        "    push rax        ; Push register\n"
        "    push rbx        ; Push back register\n"
        ...
        "        je WFSetIOModeEnd\n"
        "            mov r13, 0              "
        "; Set register to 0 (open success)\n"
        "            jmp WFSetIOModeEnd\n"
        "\n"
    ...
    ////////////////////////////////////////////////////////////////////////////
    //  WF Assembly get cursor position                                       //
    ////////////////////////////////////////////////////////////////////////////
    const char WFASMGetCursorPosition[] =
        "    call WFGetCursorPosition    ; Get cursor position\n";
